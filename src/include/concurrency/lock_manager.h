...
class LockManager {
  ...
  class LockRequest {
   public:
    LockRequest(txn_id_t txn_id, LockMode lock_mode, Transaction *tran)
        : txn_id_(txn_id), lock_mode_(lock_mode), granted_(false), tran_(tran) {}
  ...
  class LockRequestQueue {
   ...
   public:
    std::set<LockRequest, SetComparator> request_queue_;
